...
const avdelningar = [
  {
    ...
    name: 'Asken - Kronan',
    phone: '0709-66 77 71',
    email: 'kronan@asklundamontessori.se',
    imageURL: '/images/department/asken1.jpg',
    funfact: `Visste du att: Asken är ett praktfullt träd som kan bli uppemot 
    500 år och växa sig 30 meter högt. Blommorna slår ut i maj, långt
    innan löven spricker fram och pollen sprids med vinden.`,
  },
  {
    id: 1,
    name: 'Asken - Stammen',
    phone: '0730-51 56 07',
    email: 'stammen@asklundamontessori.se',
    imageURL: '/images/department/asken2.jpg',
    funfact: `Visste du att: Asken kallas ibland kungaträdet, eftersom det 
    kommer sist och går först – det vill säga att löven
    kommer sent på våren och fälls tidigt på hösten.`,
  },
  {
    id: 2,
    name: 'Björken',
      ...
      <Row>
        <Col>
          ...
          <p className="text-muted text-center">
            På Asklundamontessori har vi 10 olika avdelningar, dessa är:
          </p>
        </Col>
      </Row>
